<!--Barra de navegacion-->
<nav class="navbar navbar-expand-lg navbar-light sticky-top" style="background-color: #9966ff; " id="menu">
...
<ul class="navbar-nav ml-auto nav-flex-icons">
  ...
  <li class="nav-item dropdown">
    ...
    <span class="icon-cog"></span><img src="img/dino.png" alt="Imagen de Perfil" style="width: 30px; height:30px; border-radius:50%; ">
    </a>
